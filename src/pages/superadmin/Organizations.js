...
const fetchOrganizations = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://admin.dozemate.com/api/organizations?${queryParams}`, {
        method: 'GET',
        headers: {
  ...
  const fetchOrganizationUsers = async (orgId) => {
    ...
    try {
      const response = await fetch(`https://admin.dozemate.com/api/organizations/${orgId}/users`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
      ...
      setSelectedOrgUsers(data.users || data.data || []);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (dialogMode === 'add') {
        ...
        // Update organization
        const response = await fetch(`https://admin.dozemate.com/api/organizations/${selectedOrgId}`, {
          method: 'PUT',
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
